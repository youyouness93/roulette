  ...
  return (
    <main className="min-h-screen bg-[#0D0F15] relative overflow-hidden">
      ...
      <div className="relative min-h-screen">
        ...
        {/* Content */}
        <div className="relative container mx-auto px-4 pt-20 flex flex-col items-center">
          {/* 3D Roulette Image */}
          ...
          {/* Description */}
          <p className="text-2xl text-emerald-400/80 mb-8 max-w-2xl text-center">
          ...
          {/* Footer */}
          <footer className="w-full max-w-6xl py-12 border-t border-emerald-500/20">
